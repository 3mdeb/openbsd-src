...
typedef EFI_STATUS (*EFI_GET_TIME)(EFI_TIME *, EFI_TIME_CAPABILITIES *) EFI_ATTRIBUTES;
typedef EFI_STATUS (*EFI_SET_TIME)(EFI_TIME *) EFI_ATTRIBUTES;
typedef EFI_STATUS (*EFI_SET_VIRTUAL_ADDRESS_MAP)(UINTN, UINTN, UINT32, EFI_MEMORY_DESCRIPTOR *) EFI_ATTRIBUTES;
